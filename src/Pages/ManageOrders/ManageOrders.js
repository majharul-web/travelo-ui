...
const ManageOrders = () => {
    ...
    useEffect(() => {
        fetch('https://ancient-brushlands-56667.herokuapp.com/manageOrders')
            .then(res => res.json())
    ...
    const handleDelete = (id) => {
        ...
        if (proceed) {
            fetch(`https://ancient-brushlands-56667.herokuapp.com/allOrders/order/delete/${id}`, {
                method: 'DELETE'
            })
                .then(res => res.json())
                .then(result => {
    ...
    const handleUpdateStatus = (id) => {
        fetch(`https://ancient-brushlands-56667.herokuapp.com/orderStatus/update/${id}`,
            {
                method: 'PUT',
                headers: {
